...
<s:schema
  ...
  <!-- *
       ...
       * 
       * Note: in a further version, the checks for Kindle App will be outsurced in a separate file 
       * -->
  ...
  <s:pattern id="font-family">
    <s:rule context="*[@css:font-family]">
      <s:report test="@css:font-family eq 'sans-serif'">
        ...
        font-family:sans-serif is not supported. 
      </s:report>
      <s:report test="@css:font-family eq 'cursive'">
        <s:span class="severity">ERR</s:span>
        <s:span class="msgid">SCH_Kindle_0005</s:span>
        font-family:cursive is not supported.
      </s:report>
      <s:report test="@css:font-family eq 'fantasy'">
        <s:span class="severity">ERR</s:span>
        <s:span class="msgid">SCH_Kindle_0006</s:span>
        font-family:fantasy is not supported.
      </s:report>
      <s:report test="@css:font-family">
        <s:span class="severity">ERR</s:span>
        <s:span class="msgid">SCH_Kindle_0007</s:span>
        Individual fonts are not supported. Kindle uses a serif font per default, except the following tags where a monospace font is used: pre, code, samp, kbd, tt   
      </s:report>
    </s:rule>
  </s:pattern>
    ...
    <s:rule context="*[@css:border]">
      <s:report test="@css:border">
        ...
        <s:span class="msgid">SCH_Kindle_0026</s:span>
         Kindle and Kindle DX devices doesn't support the border property. The Kindle App for iPad/iPhone/iPod Touch draws always a 1px wide black solid border regardless of the applied styles.
      </s:report>
    </s:rule>
  </s:pattern>
  <s:pattern id="border-style">
    <s:rule context="*[@css:border-top-style]">
      <s:report test="@css:border-top-style">
        ...
        border-top-style is not supported  
      </s:report>
    </s:rule>
    <s:rule context="*[@css:border-right-style]">
      <s:report test="@css:border-right-style">
        ...
        border-right-style is not supported  
      </s:report>
    </s:rule>
    <s:rule context="*[@css:border-bottom-style]">
      <s:report test="@css:border-bottom-style">
        ...
        border-bottom-style is not supported  
      </s:report>
    </s:rule>
    <s:rule context="*[@css:border-left-style]">
      <s:report test="@css:border-left-style">
        ...
        border-left-style is not supported  
      </s:report>
    </s:rule>
    <s:rule context="*[@css:border-style]">
      <s:report test="@css:border-style">
        ...
        border-style is not supported on Kindle and Kindle DX. Kindle App for iPad/iPhone/iPod Touch draws always a solid border  
      </s:report>
    </s:rule>
  </s:pattern>
  <s:pattern id="border-width">
    <s:rule context="*[@css:border-top-width]">
      <s:report test="@css:border-top-width">
        ...
        border-top-width is not supported  
      </s:report>
    </s:rule>
    <s:rule context="*[@css:border-right-width]">
      <s:report test="@css:border-right-width">
        ...
        border-right-width is not supported  
      </s:report>
    </s:rule>
    <s:rule context="*[@css:border-bottom-width]">
      <s:report test="@css:border-bottom-width">
        ...
        border-bottom-width is not supported  
      </s:report>
    </s:rule>
    <s:rule context="*[@css:border-left-width]">
      <s:report test="@css:border-left-width">
        ...
        border-left-width is not supported  
      </s:report>
    </s:rule>
    <s:rule context="*[@css:border-width]">
      <s:report test="@css:border-width">
        ...
        border-width is not supported on Kindle and Kindle DX. Kindle App for iPad/iPhone/iPod Touch draws borders always with a width of 1px  
      </s:report>
    </s:rule>
  </s:pattern>
  <s:pattern id="border-color">
    <s:rule context="*[@css:border-top-color]">
      <s:report test="@css:border-top-color">
        <s:span class="severity">WRN</s:span>
        <s:span class="msgid">SCH_Kindle_0037</s:span>
        border-top-color is not supported  
      </s:report>
    </s:rule>
    <s:rule context="*[@css:border-right-color]">
      <s:report test="@css:border-right-color">
        <s:span class="severity">WRN</s:span>
        <s:span class="msgid">SCH_Kindle_0038</s:span>
        border-right-color is not supported  
      </s:report>
    </s:rule>
    <s:rule context="*[@css:border-bottom-color]">
      <s:report test="@css:border-bottom-color">
        <s:span class="severity">WRN</s:span>
        <s:span class="msgid">SCH_Kindle_0039</s:span>
        border-bottom-color is not supported  
      </s:report>
    </s:rule>
    <s:rule context="*[@css:border-left-color]">
      <s:report test="@css:border-left-color">
        <s:span class="severity">WRN</s:span>
        <s:span class="msgid">SCH_Kindle_0040</s:span>
        border-left-color is not supported  
      </s:report>
    </s:rule>
    <s:rule context="*[@css:border-color]">
      <s:report test="@css:border-color">
        <s:span class="severity">WRN</s:span>
        <s:span class="msgid">SCH_Kindle_0041</s:span>
        border-width is not supported on Kindle and Kindle DX. Kindle App for iPad/iPhone/iPod Touch draws always black borders  
      </s:report>
    </s:rule>
  </s:pattern>
  ...
  <s:pattern id="css-floats">
    <s:rule context="*[@css:float]">
      <s:report test="@css:float">
        <s:span class="severity">WRN</s:span>
        <s:span class="msgid">SCH_Kindle_0042</s:span>
        float not supported
      </s:report>
    </s:rule>
    <s:rule context="*[@css:clear]">
      <s:report test="@css:clear">
        <s:span class="severity">WRN</s:span>
        <s:span class="msgid">SCH_Kindle_0043</s:span>
        clear not supported
      </s:report>
    </s:rule>
  </s:pattern>
  ...
  <s:pattern id="font-variant">
    <s:rule context="*[@css:font-variant]">
      <s:report test="@css:font-variant eq 'small-caps'">
        <s:span class="severity">WRN</s:span>
        <s:span class="msgid">SCH_Kindle_0044</s:span>
  ...
  <s:pattern id="spacing">
    <s:rule context="*[@css:word-spacing]">
      <s:report test="@css:word-spacing">
        <s:span class="severity">WRN</s:span>
        <s:span class="msgid">SCH_Kindle_0045</s:span>
    ...
    <s:rule context="*[@css:letter-spacing]">
      <s:report test="@css:letter-spacing">
        <s:span class="severity">WRN</s:span>
        <s:span class="msgid">SCH_Kindle_0046</s:span>
    ...
    <s:rule context="*[@css:line-height]">
      <s:report test="@css:line-height">
        <s:span class="severity">WRN</s:span>
        <s:span class="msgid">SCH_Kindle_0047</s:span>
  ...
  <s:pattern id="list-style-type">
    <s:rule context="*[@css:list-style-type]">
      <s:report test="@css:list-style-type eq 'decimal'">
        <s:span class="severity">WRN</s:span>
        <s:span class="msgid">SCH_Kindle_0048</s:span>
      ...
      <s:report test="@css:list-style-type eq 'lower-roman'">
        <s:span class="severity">WRN</s:span>
        <s:span class="msgid">SCH_Kindle_0049</s:span>
      ...
      <s:report test="@css:list-style-type eq 'upper-roman'">
        <s:span class="severity">WRN</s:span>
        <s:span class="msgid">SCH_Kindle_0050</s:span>
      ...
      <s:report test="@css:list-style-type eq 'lower-alpha'">
        <s:span class="severity">WRN</s:span>
        <s:span class="msgid">SCH_Kindle_0051</s:span>
      ...
      <s:report test="@css:list-style-type eq 'upper-alpha'">
        <s:span class="severity">WRN</s:span>
        <s:span class="msgid">SCH_Kindle_0052</s:span>
      ...
      <s:report test="@css:list-style-type eq 'lower-greek'">
        <s:span class="severity">WRN</s:span>
        <s:span class="msgid">SCH_Kindle_0053</s:span>
      ...
      <s:report test="@css:list-style-type eq 'disc'">
        <s:span class="severity">WRN</s:span>
        <s:span class="msgid">SCH_Kindle_0054</s:span>
      ...
      <s:report test="@css:list-style-type eq 'circle'">
        <s:span class="severity">WRN</s:span>
        <s:span class="msgid">SCH_Kindle_0055</s:span>
      ...
      <s:report test="@css:list-style-type eq 'square'">
        <s:span class="severity">WRN</s:span>
        <s:span class="msgid">SCH_Kindle_0056</s:span>
      ...
      <s:report test="@css:list-style-type eq 'none'">
        <s:span class="severity">WRN</s:span>
        <s:span class="msgid">SCH_Kindle_0057</s:span>
    ...
    <s:rule context="*[@css:list-style-position]">
      <s:report test="@css:list-style-position eq 'inside'">
        <s:span class="severity">WRN</s:span>
        <s:span class="msgid">SCH_Kindle_0058</s:span>
    ...
    <s:rule context="*[@css:list-style-position]">
      <s:report test="@css:list-style-position eq 'outside'">
        <s:span class="severity">WRN</s:span>
        <s:span class="msgid">SCH_Kindle_0059</s:span>
    ...
    <s:rule context="*[@css:list-style-image]">
      <s:report test="@css:list-style-image">
        <s:span class="severity">WRN</s:span>
        <s:span class="msgid">SCH_Kindle_0060</s:span>
  ...
  <s:pattern id="display">
    <s:rule context="*[@css:display]">
      <s:report test="@css:display eq 'block'">
        <s:span class="severity">WRN</s:span>
        <s:span class="msgid">SCH_Kindle_0061</s:span>
        display:block is not supported.
      </s:report>
      <s:report test="@css:display eq 'inline'">
        <s:span class="severity">WRN</s:span>
        <s:span class="msgid">SCH_Kindle_0062</s:span>
        display:inline is not supported.
      </s:report>
      <s:report test="@css:display eq 'inline-block'">
        <s:span class="severity">WRN</s:span>
        <s:span class="msgid">SCH_Kindle_0063</s:span>
        display:inline-block is not supported.
      </s:report>
      <s:report test="@css:display eq 'inline-none'">
        <s:span class="severity">WRN</s:span>
        <s:span class="msgid">SCH_Kindle_0064</s:span>
        display:none is not supported.
      </s:report>
    </s:rule>
  </s:pattern>
  <!-- *
 ...
 <s:pattern id="color">
   <s:rule context="*[@css:color][normalize-space(.)]">
     <s:report test="@css:color[matches(., #[0-9][0-9][0-9]+)]">
       <s:span class="severity">WRN</s:span>
       <s:span class="msgid">SCH_Kindle_0065</s:span>
       color is only supported by Kindle App for iPad/iPhone/iPod Touch. 
     </s:report>
     <s:report test="@css:color[( matches(., (?i)rgb\([0-9]+,[0-9]+,[0-9]+\) ) ]">
       <s:span class="severity">WRN</s:span>
       <s:span class="msgid">SCH_Kindle_0066</s:span>
       color is only supported by Kindle App for iPad/iPhone/iPod Touch. Color statements specified in the format rgb(0-255,0-255,0-255) are not supported. Specify colors with hexadecimal values or one of the 17 CSS color keywords (except orange) instead.
     </s:report>
     <s:report test="not(@css:color eq () ('aqua' or 'black' 'blue' or 'fuchsia' or 'gray' or 'green' or 'lime' or 'maroon' or 'navy' or 'olive' or 'purple' or 'red' or 'silver' or 'teal' or 'white' or 'yellow'))">
       <s:span class="severity">WRN</s:span>
       <s:span class="msgid">SCH_Kindle_0067</s:span>
       color is only supported by Kindle App for iPad/iPhone/iPod Touch. Specify colors with hexadecimal values or one of the 17 CSS color keywords (except orange) instead.
     </s:report>
   </s:rule>
   <s:rule context="*[@css:background-color][normalize-space(.)]">
     <s:report test="@css:background-color[matches(., #[0-9][0-9][0-9]+)]">
       <s:span class="severity">WRN</s:span>
       <s:span class="msgid">SCH_Kindle_0068</s:span>
       background-color is only supported by Kindle App for iPad/iPhone/iPod Touch. 
     </s:report>
     <s:report test="@css:background-color[( matches(., (?i)rgb\([0-9]+,[0-9]+,[0-9]+\) ) ]">
       <s:span class="severity">WRN</s:span>
       <s:span class="msgid">SCH_Kindle_0069</s:span>
       background-color is only supported by Kindle App for iPad/iPhone/iPod Touch. Color statements specified in the format rgb(0-255,0-255,0-255) are not supported. Specify colors with hexadecimal values or one of the 17 CSS color keywords (except orange) instead.
     </s:report>
     <s:report test="not(@css:background-color eq () ('aqua' or 'black' 'blue' or 'fuchsia' or 'gray' or 'green' or 'lime' or 'maroon' or 'navy' or 'olive' or 'purple' or 'red' or 'silver' or 'teal' or 'white' or 'yellow'))">
       <s:span class="severity">WRN</s:span>
       <s:span class="msgid">SCH_Kindle_0070</s:span>
       background-color is only supported by Kindle App for iPad/iPhone/iPod Touch. Specify colors with hexadecimal values or one of the 17 CSS color keywords (except orange) instead.
     </s:report>
   </s:rule>
   <s:rule context="*[@css:background-color]" >
     <s:report test="@css:color">
       only background-color is displayed, when both color and background-color style are applied 
     </s:report>
   </s:rule>
 </s:pattern>
 <!-- *
  ...
  <s:pattern id="background">
    <s:rule context="*[@css:background-image]">
      <s:report test="@css:background-image">
        <s:span class="severity">WRN</s:span>
        <s:span class="msgid">SCH_Kindle_0071</s:span>
    ...
    <s:rule context="*[@css:background-repeat]">
      <s:report test="@css:background-repeat">
        <s:span class="severity">WRN</s:span>
        <s:span class="msgid">SCH_Kindle_0072</s:span>
    ...
    <s:rule context="*[@css:background-position]">
      <s:report test="@css:background-position">
        <s:span class="severity">WRN</s:span>
        <s:span class="msgid">SCH_Kindle_0073</s:span>
