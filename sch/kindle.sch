  ...
  <s:pattern id="border-model">
    ...
    <s:rule context="*[@css:border]">
      <s:report test="@css:border">
        <s:span class="severity">WRN</s:span>
        <s:span class="msgid">SCH_Kindle_0026</s:span> Kindle and Kindle DX devices doesn't support
        the border property. The Kindle App for iPad/iPhone/iPod Touch draws always a 1px wide black
        solid border regardless of the applied styles. </s:report>
    </s:rule>
  </s:pattern>
  <s:pattern id="border-style">
    ...
    <s:rule context="*[@css:border-style]">
      <s:report test="@css:border-style">
        ...
        Kindle DX. Kindle App for iPad/iPhone/iPod Touch draws always a solid border </s:report>
    </s:rule>
  </s:pattern>
  <s:pattern id="border-width">
    ...
    <s:rule context="*[@css:border-width]">
      <s:report test="@css:border-width">
        <s:span class="severity">WRN</s:span>
        <s:span class="msgid">SCH_Kindle_0036</s:span> border-width is not supported on Kindle and
        Kindle DX. Kindle App for iPad/iPhone/iPod Touch draws borders always with a width of 1px
      </s:report>
    </s:rule>
  </s:pattern>
  <s:pattern id="border-color">
    ...
    <s:rule context="*[@css:border-color]">
      <s:report test="@css:border-color">
        <s:span class="severity">WRN</s:span>
        <s:span class="msgid">SCH_Kindle_0041</s:span> border-width is not supported on Kindle and
        Kindle DX. Kindle App for iPad/iPhone/iPod Touch draws always black borders </s:report>
    </s:rule>
  </s:pattern>
  ...
  <s:pattern id="color">
    <s:rule context="*[@css:color][normalize-space(.)]">
      <s:report test="@css:color[matches(., #[0-9][0-9][0-9]+)]">
        <s:span class="severity">WRN</s:span>
        <s:span class="msgid">SCH_Kindle_0065</s:span> color is only supported by Kindle App for
        iPad/iPhone/iPod Touch. </s:report>
      <s:report test="@css:color[( matches(., (?i)rgb\([0-9]+,[0-9]+,[0-9]+\) ) ]">
        <s:span class="severity">WRN</s:span>
        <s:span class="msgid">SCH_Kindle_0066</s:span> color is only supported by Kindle App for
        iPad/iPhone/iPod Touch. Color statements specified in the format rgb(0-255,0-255,0-255) are
      ...
      <s:report
        ...
        <s:span class="severity">WRN</s:span>
        <s:span class="msgid">SCH_Kindle_0067</s:span> color is only supported by Kindle App for
        iPad/iPhone/iPod Touch. Specify colors with hexadecimal values or one of the 17 CSS color
        keywords (except orange) instead. </s:report>
    </s:rule>
    <s:rule context="*[@css:background-color][normalize-space(.)]">
      <s:report test="@css:background-color[matches(., #[0-9][0-9][0-9]+)]">
        <s:span class="severity">WRN</s:span>
        <s:span class="msgid">SCH_Kindle_0068</s:span> background-color is only supported by Kindle
        App for iPad/iPhone/iPod Touch. </s:report>
      <s:report test="@css:background-color[( matches(., (?i)rgb\([0-9]+,[0-9]+,[0-9]+\) ) ]">
        <s:span class="severity">WRN</s:span>
        <s:span class="msgid">SCH_Kindle_0069</s:span> background-color is only supported by Kindle
        App for iPad/iPhone/iPod Touch. Color statements specified in the format
        rgb(0-255,0-255,0-255) are not supported. Specify colors with hexadecimal values or one of
        the 17 CSS color keywords (except orange) instead. </s:report>
      <s:report
        ...
        <s:span class="severity">WRN</s:span>
        <s:span class="msgid">SCH_Kindle_0070</s:span> background-color is only supported by Kindle
        App for iPad/iPhone/iPod Touch. Specify colors with hexadecimal values or one of the 17 CSS
        color keywords (except orange) instead. </s:report>
    </s:rule>
